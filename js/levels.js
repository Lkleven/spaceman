...
const LEVEL_DEFS = [
  ...
  },
  {
    ...
    bgColor: ['#100a00', '#201000'],
    waves: [
      { type: 'grunt',    count: 10, interval: 0.5, xMode: 'spread', delay: 0 },
      { type: 'kamikaze', count: 6,  interval: 0.8, xMode: 'random', delay: 2 },
      { type: 'drifter',  count: 8,  interval: 0.6, xMode: 'sides',  delay: 2 },
      { type: 'gunner',   count: 4,  interval: 1.2, xMode: 'spread', delay: 3 },
    ],
  },
  {
